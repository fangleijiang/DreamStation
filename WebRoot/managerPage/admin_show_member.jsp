...
return false;
  ...
  <div class="body">
		...
		<div class="right">
		<center><h1>成员管理</h1></center>
		
		<form action="findMemberByName.action" method="post">
    		请输入需要查找的姓名：<input type="text" name="member.name"/>
 	 ...
 	 <s:iterator value="listMember" id="member" status="status">
			...
			<s:iterator value="pagebean">
				<td> <input type="button" value="添加" name="添加" onclick="window.location='addmember.jsp'"></input></td>
					<td colspan="12"><s:if test="%{currentPage == 1}">
							...
							<a href="find_black_first_four.action?page=1"><input
								type="button" value="第一页" /></a>
							

							<a
								href="find_black_first_four.action?page=<s:property value="%{currentPage-1}"/>"><input
						...
						共 <font color="red"><s:property
						 ...
						 <s:if test="%{currentPage != totalPage}">
							...
							<a
								href="find_black_first_four.action?page=<s:property value="totalPage"/>"><input
