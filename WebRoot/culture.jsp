	...
	<div class="nav_bulb">
		<div class="nav">
			<a href="list_info_to_index.action"><img
				src="image/border_11.gif">
			</a> <a href="list_front_image.action" target=""><img
				src="image/border_12.gif">
			</a> <a href="listFrontNews.action" target=""><img
				src="image/border_13.gif">
			</a> <a href="client_project_page_Action.action" target=""><img
				src="image/border_14.gif">
			</a>
		</div>
			<div class="bulb">
		<a href="client_page_action.action"><img src="image/bulb.png"></img>
		</a>
	</div>
	</div>
		<div class="content2" align="center">
			<font face="楷体">梦之站文化</font>
		</div>
				...
				<s:iterator value="#request.list" id="culture" status="status">
					<tr>
						<td><font face=微软雅黑> &nbsp;&nbsp;<s:property
									value="#culture.title" escape="false" />
						</font><br>
							------------------------------------------------------------</td>
					</tr>
					<tr>
						<td><font size="3px" face=微软雅黑> <s:property
									value="#culture.content" escape="false" /> </font>
						<p>
						</td>
					</tr>
